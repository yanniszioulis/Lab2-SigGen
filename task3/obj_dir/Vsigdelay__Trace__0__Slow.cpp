...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,"mic_signal", false,-1, 8,0);
    tracep->declBus(c+9,"delayed_signal", false,-1, 8,0);
    ...
    tracep->declBus(c+8,"mic_signal", false,-1, 8,0);
    tracep->declBus(c+9,"delayed_signal", false,-1, 8,0);
    tracep->declBus(c+10,"wr_address", false,-1, 8,0);
    tracep->declBus(c+11,"rd_address", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,(vlSelf->mic_signal),9);
    bufp->fullSData(oldp+9,(vlSelf->delayed_signal),9);
    bufp->fullSData(oldp+10,(vlSelf->sigdelay__DOT__wr_address),9);
    bufp->fullSData(oldp+11,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__wr_address) 
                                        - (IData)(vlSelf->offset)))),9);
    bufp->fullSData(oldp+12,(vlSelf->incr),9);
    bufp->fullCData(oldp+13,((0xffU & (IData)(vlSelf->mic_signal))),8);
    bufp->fullCData(oldp+14,(vlSelf->sigdelay__DOT____Vcellout__sigRam__dout),8);
